...
export const AGENTS: Agent[] = [
  {
    symbol: 'AAPL',
    name: '$SAAPL · Stocknized AAPL Agent',
    thesis:
      'Live on mainnet — quoted in AAPLx, every trade settles in tokenized Apple stock. Launched autonomously by an agent funded by an agent.',
    feesEarned: 0,
    basisCaptured: 0,
    tvl: 0,
    roi: 0,
    backers: 1,
    mint: 'DWMgU6wE3SbnvrCC41FNVFvAG8EoHCFYMW2EAvQZ4s7G',
    pool: 'pump.fun curve · quote AAPLx',
    strategy: 'basis',
  },
  {
    symbol: 'CAAPL',
    name: '$CAAPL · CLASP AAPL Agent',
    thesis:
      'First CLASP launch — self-funded by the CLASP agent from its own wallet on Clawpump. Tracks the AAPLx basis.',
    feesEarned: 0,
    basisCaptured: 0,
    tvl: 0,
    roi: 0,
    backers: 1,
    mint: '6AjyCgMvMp4WX8eRoWqYBuGX3yKRFQAGDFZsv4m2Mwrv',
    pool: 'pump.fun curve · quote SOL',
    strategy: 'basis',
  },
];
