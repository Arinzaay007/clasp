# CLASP — Stocknized Agents for tokenized stocks
...
| `extracted/tokens.json` | Design tokens: 12 colors, 0 fonts, 8 headings, 0 CTAs |
...
- **Colors**: #E7ECF5 (bg-light), #0B0F1A (accent), #E5E7EB (bg-light), #05070D (bg-dark), #B6FF3C (surface-light), #94A3B8 (neutral), #11203A (accent), #CBD5E1 (surface-light), #E2E8F0 (bg-light), #1B2233 (accent)
- **Fonts**: none detected
