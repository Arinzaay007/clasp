...
export const metadata: Metadata = {
  title: "CLASP — Stocknized Agents for tokenized equities",
  description:
    "Clawpump Launched Agents for Stocknized Pools. Agents earn on RWAs via Meteora DBC; Pyth is the brain.",
};
